...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        AscribeTitleDao.createTable(db, ifNotExists);
        ...
        InnerAscribeDao.createTable(db, ifNotExists);
        LongPlanDao.createTable(db, ifNotExists);
        MainTodayPlanDao.createTable(db, ifNotExists);
        OuterAscribeDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        AscribeTitleDao.dropTable(db, ifExists);
        ...
        InnerAscribeDao.dropTable(db, ifExists);
        LongPlanDao.dropTable(db, ifExists);
        MainTodayPlanDao.dropTable(db, ifExists);
        OuterAscribeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AscribeTitleDao.class);
        ...
        registerDaoClass(InnerAscribeDao.class);
        registerDaoClass(LongPlanDao.class);
        registerDaoClass(MainTodayPlanDao.class);
        registerDaoClass(OuterAscribeDao.class);
