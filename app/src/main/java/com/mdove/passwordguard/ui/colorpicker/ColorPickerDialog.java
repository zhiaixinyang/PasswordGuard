...
package com.mdove.passwordguard.ui.colorpicker;
...
import com.mdove.passwordguard.ui.colorpicker.ColorPickerSwatch.*;

/**
 * A dialog which takes in as input an array of palette and creates a palette allowing the user to
 * select a specific color swatch, which invokes a listener.
 */
public class ColorPickerDialog extends AppCompatDialogFragment implements ColorPickerSwatch.OnColorSelectedListener {
