package com.mdove.passwordguard.ui.pickerview.view;
...
import com.mdove.passwordguard.ui.pickerview.listener.OnDismissListener;
import com.mdove.passwordguard.ui.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_base_pickerview, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.layout_base_pickerview, decorView, false);
