package com.mdove.passwordguard.ui.renkstar;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_track_size, DensityUtil.dip2px(App.getAppContext(),2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_second_track_size,
                mTrackSize + DensityUtil.dip2px(App.getAppContext(),2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_radius,
                mSecondTrackSize + DensityUtil.dip2px(App.getAppContext(),2));
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_section_text_size, DensityUtil.sp2px(App.getAppContext(),14));
        ...
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_thumb_text_size, DensityUtil.sp2px(App.getAppContext(),14));
        ...
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_bubble_text_size, DensityUtil.sp2px(App.getAppContext(),14));
        ...
        mRectText = new Rect();
        mTextSpace = DensityUtil.dip2px(App.getAppContext(),2);
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + DensityUtil.sp2px(App.getAppContext(),2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + DensityUtil.sp2px(App.getAppContext(),2);
        }
    ...
    private void calculateRadiusOfBubble() {
        ...
        mBubbleRadius = DensityUtil.sp2px(App.getAppContext(),14); // default 14dp
    ...
    private void locatePositionOnScreen() {
        ...
        mBubbleCenterRawSolidY -= DensityUtil.sp2px(App.getAppContext(),24);
        if (BubbleUtils.isMIUI()) {
            mBubbleCenterRawSolidY += DensityUtil.sp2px(App.getAppContext(),4);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            float r = (mThumbRadiusOnDragging - DensityUtil.sp2px(App.getAppContext(),2)) / 2f;
    ...
    private boolean isThumbTouched(MotionEvent event) {
        ...
        return (event.getX() - x) * (event.getX() - x) + (event.getY() - y) * (event.getY() - y)
                <= (mLeft + DensityUtil.sp2px(App.getAppContext(),8)) * (mLeft + DensityUtil.sp2px(App.getAppContext(),8));
    }
    ...
    private class BubbleView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            mBubblePath.quadTo(
                    x1 - DensityUtil.sp2px(App.getAppContext(),2), y1 - DensityUtil.sp2px(App.getAppContext(),2),
                    x1, y1
            );
            ...
            mBubblePath.quadTo(
                    x2 + DensityUtil.sp2px(App.getAppContext(),2), y1 - DensityUtil.sp2px(App.getAppContext(),2),
                    x0, y0
            );
            mBubblePath.close();
