package com.mdove.passwordguard.ui.tablayout;
...
import com.mdove.passwordguard.utils.AnimationUtils;
            ...
            if (mCustomView == null) {
                ...
                if (mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext())
                            .inflate(R.layout.view_ext_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    mIconView = iconView;
                }
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(R.layout.view_ext_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
