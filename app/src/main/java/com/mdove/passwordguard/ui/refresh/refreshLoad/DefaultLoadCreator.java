package com.mdove.passwordguard.ui.refresh.refreshLoad;
...
import com.mdove.passwordguard.ui.refresh.widget.LoadViewCreator;
...
public class DefaultLoadCreator extends LoadViewCreator {
    ...
    public View getLoadView(Context context, ViewGroup parent) {
        View refreshView = LayoutInflater.from(context).inflate(R.layout.layout_load_footer_view_others_recyclerview, parent, false);
