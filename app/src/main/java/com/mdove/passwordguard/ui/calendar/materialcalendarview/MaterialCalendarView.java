...
import com.mdove.passwordguard.ui.calendar.materialcalendar.Preference;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.ArrayWeekDayFormatter;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.DateFormatTitleFormatter;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.DayFormatter;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.MonthArrayTitleFormatter;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.TitleFormatter;
import com.mdove.passwordguard.ui.calendar.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    //titleChanger 会根据这个值来设置标题，所以更改这个就会改变标题
    ...
    private void updateUi() {
        titleChanger.change(currentMonth,false);
        buttonPast.setEnabled(canGoBack());
        buttonFuture.setEnabled(canGoForward());
    }
    //强制改变title
    public void changeTitle(CalendarDay day) {
        titleChanger.change(day,true);
    }
    /**
    ...
    public void setDateTextAppearance(int resourceId) {
        ...
        Preference.dayTextSize= DensityUtil.sp2px(
