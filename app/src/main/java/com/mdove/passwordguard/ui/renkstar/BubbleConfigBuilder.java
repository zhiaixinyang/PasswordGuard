...
public class BubbleConfigBuilder {
    ...
    public BubbleConfigBuilder trackSize(int dp) {
        this.trackSize = DensityUtil.dip2px(App.getAppContext(),dp);
        return this;
    }

    public BubbleConfigBuilder secondTrackSize(int dp) {
        this.secondTrackSize = DensityUtil.dip2px(App.getAppContext(),dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadius(int dp) {
        this.thumbRadius = DensityUtil.dip2px(App.getAppContext(),dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadiusOnDragging(int dp) {
        this.thumbRadiusOnDragging = DensityUtil.dip2px(App.getAppContext(),dp);
        return this;
    }
    ...
    public BubbleConfigBuilder sectionTextSize(int sp) {
        this.sectionTextSize = DensityUtil.dip2px(App.getAppContext(),sp);
        return this;
    }
    ...
    public BubbleConfigBuilder thumbTextSize(int sp) {
        this.thumbTextSize = DensityUtil.dip2px(App.getAppContext(),sp);
        return this;
    }
    ...
    public BubbleConfigBuilder bubbleTextSize(int sp) {
        this.bubbleTextSize = DensityUtil.dip2px(App.getAppContext(),sp);
        return this;
    }
