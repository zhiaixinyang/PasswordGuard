...
public class AllPlanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<AllPlanModel> mData;
    private Context mContext;
    private AllPlanPresenter mPresenter;

    public AllPlanAdapter(Context context, AllPlanPresenter presenter) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(AllPlanModel model) {
            ...
            mBinding.rlvSinglePlan.setAdapter(new RlvAllPlanAdapter(mContext, data));
        }
    }

    public void setData(List<AllPlanModel> data) {
        mData = data;
