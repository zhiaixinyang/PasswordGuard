...
public class ScheduleShortAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ScheduleShortAdapter(Context context, SchedulePresenter presenter) {
